...
export default function Sidebar({ className = '' }: SidebarProps) {
  ...
  return (
    <aside className={`hidden md:flex flex-col w-64 h-screen fixed left-0 top-0 bg-white border-r border-gray-200 z-40 ${className}`}>
      {/* Header / Logo */}
      ...
      <div className="p-4 border-t border-gray-100">
        <div className="flex items-center px-3 py-2.5 text-sm font-semibold text-gray-400 rounded-xl cursor-not-allowed">
          <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
